...
LIST_OF_A = [200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200]
...
for test_case_id in range(1, NUM_TEST_CASES + 1):
  ...
  for mmm in range(1000):
    ...
    if not (prepared_i, prepared_j) in field:
      ...
      if PRINT_INTERACTION_HISTORY:
        print("{} / {}".format(prepared_cells_count, (southmost - northmost + 1) * (eastmost - westmost + 1)))
      if (prepared_cells_count >=
          A) and (prepared_cells_count == (southmost - northmost + 1) *
                  (eastmost - westmost + 1)):
        JudgePrint(p, "0 0")
        print("Test Case #{}: Passed in {}".format(test_case_id, mmm))
